...
CREATE TABLE `artfarm`.`notice` (
	...
	`content`     VARCHAR(1000)    NULL     COMMENT '공지내용', -- 공지내용
...
CREATE TABLE `artfarm`.`exhibition` (
	...
	`subtitle`       VARCHAR(256)        NULL     COMMENT '부제', -- 부제
	`discription`    VARCHAR(1000)       NULL     COMMENT '소개', -- 소개
	`thubnail`       VARCHAR(256)        NULL     COMMENT '썸네일', -- 썸네일
